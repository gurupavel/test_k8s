...
stage('Build') {
    ...
    stage('Deploy on kubernetes') {
      steps {
       configFileProvider([configFile(fileId: '35b09e42-54db-47e5-9b53-d08712e763e4', targetLocation: '/tmp/',variable: 'k8s_settings')]) {
	    load '/tmp/35b09e42-54db-47e5-9b53-d08712e763e4'
